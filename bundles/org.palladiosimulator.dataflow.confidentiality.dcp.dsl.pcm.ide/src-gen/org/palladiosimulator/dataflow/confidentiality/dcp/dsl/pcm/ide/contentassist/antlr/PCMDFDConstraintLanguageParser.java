...
public class PCMDFDConstraintLanguageParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, PCMDFDConstraintLanguageGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getTargetModelTypeDefAccess().getGroup_4(), "rule__TargetModelTypeDef__Group_4__0");
			...
			builder.put(grammarAccess.getNodeIdentitiySelectorAccess().getGroup_1_1_1(), "rule__NodeIdentitiySelector__Group_1_1_1__0");
			builder.put(grammarAccess.getNodeIdentitiySelectorAccess().getGroup_1_1_2(), "rule__NodeIdentitiySelector__Group_1_1_2__0");
			builder.put(grammarAccess.getNodeIdentitiySelectorAccess().getGroup_1_1_3(), "rule__NodeIdentitiySelector__Group_1_1_3__0");
			builder.put(grammarAccess.getNodeIdentitiySelectorAccess().getGroup_1_1_4(), "rule__NodeIdentitiySelector__Group_1_1_4__0");
			...
			builder.put(grammarAccess.getTargetModelTypeDefAccess().getUsageModelAssignment_4_1(), "rule__TargetModelTypeDef__UsageModelAssignment_4_1");
			builder.put(grammarAccess.getTargetModelTypeDefAccess().getRepositoryModelAssignment_4_3(), "rule__TargetModelTypeDef__RepositoryModelAssignment_4_3");
			...
			builder.put(grammarAccess.getNodeIdentitiySelectorAccess().getAssemblyAssignment_1_1_0_1(), "rule__NodeIdentitiySelector__AssemblyAssignment_1_1_0_1");
			builder.put(grammarAccess.getNodeIdentitiySelectorAccess().getComponentAssignment_1_1_0_3(), "rule__NodeIdentitiySelector__ComponentAssignment_1_1_0_3");
			builder.put(grammarAccess.getNodeIdentitiySelectorAccess().getActionAssignment_1_1_1_1(), "rule__NodeIdentitiySelector__ActionAssignment_1_1_1_1");
			builder.put(grammarAccess.getNodeIdentitiySelectorAccess().getAssemblyAssignment_1_1_2_1(), "rule__NodeIdentitiySelector__AssemblyAssignment_1_1_2_1");
			builder.put(grammarAccess.getNodeIdentitiySelectorAccess().getComponentAssignment_1_1_2_3(), "rule__NodeIdentitiySelector__ComponentAssignment_1_1_2_3");
			builder.put(grammarAccess.getNodeIdentitiySelectorAccess().getSignatureAssignment_1_1_2_5(), "rule__NodeIdentitiySelector__SignatureAssignment_1_1_2_5");
			builder.put(grammarAccess.getNodeIdentitiySelectorAccess().getUserActionAssignment_1_1_3_1(), "rule__NodeIdentitiySelector__UserActionAssignment_1_1_3_1");
			builder.put(grammarAccess.getNodeIdentitiySelectorAccess().getAssemblyAssignment_1_1_4_1(), "rule__NodeIdentitiySelector__AssemblyAssignment_1_1_4_1");
			builder.put(grammarAccess.getNodeIdentitiySelectorAccess().getStoreAssignment_1_1_4_3(), "rule__NodeIdentitiySelector__StoreAssignment_1_1_4_3");
