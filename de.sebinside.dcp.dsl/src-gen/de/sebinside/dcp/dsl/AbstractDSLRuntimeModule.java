...
import de.sebinside.dcp.dsl.parser.antlr.DSLAntlrTokenFileProvider;
import de.sebinside.dcp.dsl.parser.antlr.DSLParser;
import de.sebinside.dcp.dsl.parser.antlr.internal.InternalDSLLexer;
import de.sebinside.dcp.dsl.scoping.DSLScopeProvider;
import de.sebinside.dcp.dsl.serializer.DSLSemanticSequencer;
import de.sebinside.dcp.dsl.serializer.DSLSyntacticSequencer;
import de.sebinside.dcp.dsl.services.DSLGrammarAccess;
import de.sebinside.dcp.dsl.validation.DSLConfigurableIssueCodesProvider;
...
public abstract class AbstractDSLRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "de/sebinside/dcp/dsl/DSL.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("de.sebinside.dcp.dsl.DSL");
	}
