...
public class PCMDFDConstraintLanguageParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, PCMDFDConstraintLanguageGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getPCMTargetModelTypeDefAccess().getGroup(), "rule__PCMTargetModelTypeDef__Group__0");
			...
			builder.put(grammarAccess.getComponentIdentitySelectorAccess().getGroup(), "rule__ComponentIdentitySelector__Group__0");
			...
			builder.put(grammarAccess.getModelAccess().getTargetModelTypeAssignment_0_0(), "rule__Model__TargetModelTypeAssignment_0_0");
			builder.put(grammarAccess.getModelAccess().getPcmTargetModelTypeAssignment_0_1(), "rule__Model__PcmTargetModelTypeAssignment_0_1");
			builder.put(grammarAccess.getModelAccess().getElementsAssignment_1(), "rule__Model__ElementsAssignment_1");
			builder.put(grammarAccess.getPCMTargetModelTypeDefAccess().getTypeAssignment_1(), "rule__PCMTargetModelTypeDef__TypeAssignment_1");
			...
			builder.put(grammarAccess.getComponentIdentitySelectorAccess().getNameAssignment_1(), "rule__ComponentIdentitySelector__NameAssignment_1");
			...
			builder.put(grammarAccess.getRuleAccess().getDestinationSelectorsAssignment_0(), "rule__Rule__DestinationSelectorsAssignment_0");
			builder.put(grammarAccess.getRuleAccess().getDestinationSelectorsAssignment_1_1(), "rule__Rule__DestinationSelectorsAssignment_1_1");
			builder.put(grammarAccess.getRuleAccess().getStatementAssignment_2(), "rule__Rule__StatementAssignment_2");
			builder.put(grammarAccess.getRuleAccess().getDataSelectorsAssignment_3(), "rule__Rule__DataSelectorsAssignment_3");
			builder.put(grammarAccess.getRuleAccess().getDataSelectorsAssignment_4_1(), "rule__Rule__DataSelectorsAssignment_4_1");
