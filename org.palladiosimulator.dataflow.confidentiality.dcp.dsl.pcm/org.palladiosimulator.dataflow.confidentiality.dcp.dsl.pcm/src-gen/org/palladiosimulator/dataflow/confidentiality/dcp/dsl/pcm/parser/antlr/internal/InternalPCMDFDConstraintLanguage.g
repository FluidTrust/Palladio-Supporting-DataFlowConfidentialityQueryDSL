 ...
 */
grammar InternalPCMDFDConstraintLanguage;
...
// Entry rule entryRulePCMTargetModelTypeDef
entryRulePCMTargetModelTypeDef returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getPCMTargetModelTypeDefRule()); }
	iv_rulePCMTargetModelTypeDef=rulePCMTargetModelTypeDef
	{ $current=$iv_rulePCMTargetModelTypeDef.current; }
	EOF;

// Rule PCMTargetModelTypeDef
rulePCMTargetModelTypeDef returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
@after {
	...
	(
		...
		{
			$current = $this_ComponentIdentitySelector_2.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
// Entry rule entryRuleComponentIdentitySelector
entryRuleComponentIdentitySelector returns [EObject current=null]:
	...
	{ $current=$iv_ruleComponentIdentitySelector.current; }
	EOF;

// Rule ComponentIdentitySelector
ruleComponentIdentitySelector returns [EObject current=null]
@init {
	enterRule();
}
@after {
