...
import org.palladiosimulator.dataflow.confidentiality.transformation.workflow.tests.JPMailAnalysisTest
...
class JPMailAnalysisDCPTest extends JPMailAnalysisTest{
	...
	override findFlaws() {
		InformationFlowTumaDCPTestUtil.findFlaws(prover, dcpBuilder, InformationFlowTumaTestCases.JPMAIL.toString)
	}
}
