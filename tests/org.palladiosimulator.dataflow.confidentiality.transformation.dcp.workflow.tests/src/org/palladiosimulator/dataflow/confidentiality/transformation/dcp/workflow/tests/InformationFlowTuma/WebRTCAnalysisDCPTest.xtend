...
import org.palladiosimulator.dataflow.confidentiality.transformation.workflow.tests.WebRTCAnalysisTest
...
class WebRTCAnalysisDCPTest extends WebRTCAnalysisTest {
	...
	override findFlaws() {
		InformationFlowTumaDCPTestUtil.findFlaws(prover, dcpBuilder, InformationFlowTumaTestCases.WEBRCT.toString)
	}
}
